...
import { Check, Quote, ArrowRight, BrainCircuit, Target, Users, Scaling, Globe, ShieldCheck, ThumbsDown, ThumbsUp, UserCheck, CalendarDays, FileText, CheckSquare, Award, GanttChartSquare } from 'lucide-react';
...
import data from '@/content/pages/hire/landing.json';

export const metadata: Metadata = {
  title: "Hire Elite Engineers in LATAM | TeamStation AI",
  description: "Axiom Cortex™ identifies elite nearshore engineers through cognitive vetting, not coding trivia. Hire qualitative talent, not top 5% statistics.",
};
...
const proofIcons: { [key: string]: React.ElementType } = {
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 space-y-16 md:space-y-24 py-16 md:py-24">
        ...
        <section className="text-center max-w-4xl mx-auto">
           <div className="relative rounded-xl border border-border p-8 md:p-12
             bg-[radial-gradient(80%_60%_at_50%_0%,rgba(138,180,255,0.1),transparent_70%)]">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-text">{data.hero.headline}</h1>
          ...
          <div className="border-t border-border md:border-t-0 md:border-l md:pl-8 pt-8 md:pt-0">
            ...
            <ul className="mt-4 space-y-3">
              {data.psp.proof.map((item: string) => {
                const Icon = proofIcons[item] || Check;
                return (
        ...
        <section className="max-w-5xl mx-auto text-center">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
            ...
            <Card className="bg-bg-elev border-border">
              <CardHeader>
                <Scaling className="w-8 h-8 text-primary mb-2" />
                        ...
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <CardTitle className="font-semibold text-xl text-text">{category.name}</CardTitle>
                                </div>
