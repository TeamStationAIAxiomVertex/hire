...
* Type: page
* Route: /roles/mobile
* Description: Displays a list of technologies for the Mobile role category.
* Acceptance:
* ✅ Compiles without TypeScript errors
* ✅ Lints and formats cleanly
* ✅ Generates a static page for the mobile category.
...
import { MobileSEOArticle } from &quot;@/components/roles/articles/mobile-article&quot;;
import DynamicIcon from &quot;@/components/DynamicIcon&quot;;

export async function generateMetadata(): Promise<Metadata> {
  const category = categories.find((c) => c.slug === ’mobile’);
  if (!category) {
    return {
