...
* Type: page
* Route: /roles/vetted-talent
* Description: Displays information about the Vetting & Cognitive AI category.
* Acceptance:
* ✅ Compiles without TypeScript errors
* ✅ Lints and formats cleanly
* ✅ Generates a static page for the vetted-talent category.
...
import { CognitiveAiVettingSEOArticle } from &quot;@/components/roles/articles/cognitive-ai-vetting-article&quot;;
import DynamicIcon from &quot;@/components/DynamicIcon&quot;;

export async function generateMetadata(): Promise<Metadata> {
  const category = categories.find((c) => c.slug === ’vetted-talent’);
  if (!category) {
    return {
  ...
  const title = `Hire with ${category.name} | TeamStation AI`;

  return {
    title,
    description: category.description,
    alternates: {
      canonical: `/roles/vetted-talent`,
    },
  };
}
