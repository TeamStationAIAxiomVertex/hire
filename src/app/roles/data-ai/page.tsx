...
* Type: page
* Route: /roles/data-ai
* Description: Displays a list of technologies for the Data & AI role category.
* Acceptance:
...
import { DataAiSEOArticle } from "@/components/roles/articles/data-ai-article";
import DynamicIcon from "@/components/DynamicIcon";

type PageProps = { params: { slug: string } };

export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const category = categories.find((c) => c.slug === 'data-ai');
  if (!category) {
    return {
