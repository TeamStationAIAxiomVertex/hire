...
export default function RolePage({ params }: PageProps) {
  ...
  // Statically handle the pages that have custom components.
  if (['product', 'frontend-web', 'backend-services', 'devops-cloud', 'data-ai', 'salesforce-ecosystem', 'sap-ecosystem', 'microsoft-ecosystem', 'oracle-ecosystem', 'databases', 'qa-security', 'architecture-integrations', 'mobile', 'vetted-talent'].includes(category.slug)) {
    notFound();
  }
