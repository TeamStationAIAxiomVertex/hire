...
* Type: page
* Route: /roles/microsoft-ecosystem
* Description: Displays a list of technologies for the Microsoft Ecosystem role category.
* Acceptance:
...
import { MicrosoftEcosystemSEOArticle } from &quot;@/components/roles/articles/microsoft-ecosystem-article&quot;;
import DynamicIcon from &quot;@/components/DynamicIcon&quot;;

type PageProps = { params: { slug: string } };

export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const category = categories.find((c) => c.slug === ’microsoft-ecosystem’);
  if (!category) {
    return {
  ...
  return {
    ...
    alternates: {
      canonical: `/roles/microsoft-ecosystem`,
    },
  };
}
...
export async function generateStaticParams() {
  return [{ slug: ’microsoft-ecosystem’ }];
}
