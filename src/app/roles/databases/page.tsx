/** @Spec
* Feature: Role Category Page - Databases
* Type: page
* Route: /roles/databases
* Description: Displays a list of technologies for the Databases role category.
* Acceptance:
* ✅ Compiles without TypeScript errors
* ✅ Lints and formats cleanly
* ✅ Generates a static page for the databases category.
...
import { DatabasesSEOArticle } from "@/components/roles/articles/databases-article";
import DynamicIcon from "@/components/DynamicIcon";

export async function generateMetadata(): Promise<Metadata> {
  const category = categories.find((c) => c.slug === 'databases');
  if (!category) {
    return {
