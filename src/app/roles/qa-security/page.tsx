/** @Spec
* Feature: Role Category Page - QA & Security
* Type: page
* Route: /roles/qa-security
* Description: Displays a list of technologies for the QA & Security role category.
* Acceptance:
* ✅ Compiles without TypeScript errors
* ✅ Lints and formats cleanly
* ✅ Generates a static page for the qa-security category.
...
import { QaSecuritySEOArticle } from &quot;@/components/roles/articles/qa-security-article&quot;;
import DynamicIcon from &quot;@/components/DynamicIcon&quot;;

export async function generateMetadata(): Promise<Metadata> {
  const category = categories.find((c) => c.slug === ’qa-security’);
  if (!category) {
    return {
