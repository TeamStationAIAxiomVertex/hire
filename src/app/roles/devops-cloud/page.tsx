...
* Type: page
* Route: /roles/devops-cloud
* Description: Displays a list of technologies for the DevOps & Cloud role category.
* Acceptance:
...
import { DevOpsCloudSEOArticle } from &quot;@/components/roles/articles/devops-cloud-article&quot;;
import DynamicIcon from &quot;@/components/DynamicIcon&quot;;

type PageProps = { params: { slug: string } };

export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const category = categories.find((c) => c.slug === ’devops-cloud’);
  if (!category) {
    return {
