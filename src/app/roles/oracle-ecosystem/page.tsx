...
* Type: page
* Route: /roles/oracle-ecosystem
* Description: Displays a list of technologies for the Oracle Ecosystem role category.
* Acceptance:
...
import { OracleEcosystemSEOArticle } from "@/components/roles/articles/oracle-ecosystem-article";
import DynamicIcon from "@/components/DynamicIcon";

type PageProps = { params: { slug: string } };

export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const category = categories.find((c) => c.slug === 'oracle-ecosystem');
  if (!category) {
    return {
  ...
  return {
    ...
    alternates: {
      canonical: `/roles/oracle-ecosystem`,
    },
  };
}
