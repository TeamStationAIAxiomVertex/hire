...
* Type: page
* Route: /roles/sap-ecosystem
* Description: Displays a list of technologies for the SAP Ecosystem role category.
* Acceptance:
...
import { SapEcosystemSEOArticle } from "@/components/roles/articles/sap-ecosystem-article";
import DynamicIcon from "@/components/DynamicIcon";

type PageProps = { params: { slug: string } };

export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const category = categories.find((c) => c.slug === 'sap-ecosystem');
  if (!category) {
    return {
