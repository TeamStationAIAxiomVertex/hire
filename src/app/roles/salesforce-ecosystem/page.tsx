...
* Type: page
* Route: /roles/salesforce-ecosystem
* Description: Displays a list of technologies for the Salesforce Ecosystem role category.
* Acceptance:
...
import { SalesforceEcosystemSEOArticle } from &quot;@/components/roles/articles/salesforce-ecosystem-article&quot;;
import DynamicIcon from &quot;@/components/DynamicIcon&quot;;

type PageProps = { params: { slug: string } };

export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const category = categories.find((c) => c.slug === ’salesforce-ecosystem’);
  if (!category) {
    return {
  ...
  return {
    ...
    alternates: {
      canonical: `/roles/salesforce-ecosystem`,
    },
  };
}
...
export async function generateStaticParams() {
  return [{ slug: ’salesforce-ecosystem’ }];
}
