...
* Type: page
* Route: /roles/architecture-integrations
* Description: Displays a list of technologies for the Architecture & Integrations role category.
* Acceptance:
...
import { ArchitectsIntegrationsSEOArticle } from "@/components/roles/articles/architects-integrations-article";
import DynamicIcon from "@/components/DynamicIcon";

type PageProps = { params: { slug: string } };

export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const category = categories.find((c) => c.slug === 'architecture-integrations');
  if (!category) {
    return {
  ...
  return {
    ...
    alternates: {
      canonical: `/roles/architecture-integrations`,
    },
  };
}
...
export default function RolePage({ params }: PageProps) {
  ...
  return (
    <div className="container mx-auto py-16 space-y-12 max-w-screen-xl">
      ...
      <ArchitectsIntegrationsSEOArticle />
