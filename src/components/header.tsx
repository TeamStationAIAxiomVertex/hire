...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/30 bg-bg-elev/60 backdrop-blur-lg">
              ...
              {allCategories.map((category) => (
                <DropdownMenuItem key={category.slug} asChild>
                  <Link
                    ...
                    className="flex items-start gap-3"
                  >
                    <DynamicIcon name={category.icon} className="mr-2 h-5 w-5 mt-1 text-primary flex-shrink-0" />
                    <div>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    {allCategories.map((category) => (
                      <Link
                        ...
                        onClick={() => setIsMobileMenuOpen(false)}
                      >
                        <DynamicIcon name={category.icon} className="h-5 w-5 mt-1 text-primary flex-shrink-0" />
                        <div>
