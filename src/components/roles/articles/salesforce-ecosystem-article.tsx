  ...
  return (
    <article className="mt-16 prose dark:prose-invert max-w-none text-muted leading-7">
      ...
      <section className="mt-16 pt-12 border-t border-border">
          <h2 className="text-3xl font-semibold text-text mb-4 flex items-center gap-3"><DynamicIcon name="ShieldCheck" className="w-8 h-8 text-primary"/> Intellectual Property & Legal Compliance in Salesforce Development</h2>
          <div className="space-y-6">
              <div className="bg-bg-elev border rounded-xl p-6">
